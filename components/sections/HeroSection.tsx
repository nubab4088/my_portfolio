        ...
        <div className="grid items-center gap-16 lg:grid-cols-[1.25fr_0.9fr]">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="max-w-2xl text-base sm:text-lg leading-relaxed text-[#a0a0a0] font-normal">
              Aspiring Software Engineer with strong interests in full-stack development, AI integration, and
              research-oriented problem solving. Passionate about building innovative software solutions that
              create real-world impact while continuously learning, adapting, and contributing in collaborative
              environments.
            </motion.p>
